    ...
    public void onClick(final View v) {
        ...
        if (v == Choose) {
            ...
            {if (Pa == C1) {Strike++;}
                ...
                if (Pa != C1 && Pa != C2 && Pa != C3){OutCnt++;}
                if (Pb != C1 && Pb != C2 && Pb != C3){OutCnt++;}
                if (Pc != C1 && Pc != C2 && Pc != C3){OutCnt++;}
                if (OutCnt == 3){Out++; OutCnt = 0;}
                switch (life){
                    case 8 :
                        T1.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃");
                        life--; Te.setText("7"); Strike = 0; Ball = 0; Out = 0; break;
                case 7 :
                    T2.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃");
                    life--; Te.setText("6"); Strike = 0; Ball = 0; Out = 0; break;
                case 6 :
                    T3.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃");
                    life--; Te.setText("5"); Strike = 0; Ball = 0; Out = 0; break;
                    case 5 :
                        T4.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃");
                        life--; Te.setText("4"); Strike = 0; Ball = 0; Out = 0; break;
                    case 4 :
                        T5.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃");
                        life--;Te.setText("3"); Strike = 0; Ball = 0; Out = 0; break;
                    case 3 :
                        T6.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃");
                        life--; Te.setText("2"); Strike = 0; Ball = 0; Out = 0; break;
                    case 2 :
                        T7.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃"+C1+C2+C3);
                        life--; Te.setText("1"); Strike = 0; Ball = 0; Out = 0; break;
                    case 1 :
                        T8.setText(Strike+"스트라이크, "+Ball+"볼, "+Out+"아웃");
                        life--;Te.setText("0"); Strike = 0; Ball = 0; Out = 0; break;
                }
                if (life == 0){
